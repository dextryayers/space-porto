        ...
        {items.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <div className="absolute top-12 md:top-14 left-4 md:left-6 right-4 md:right-6 z-10 animate-fade-slide-up">
                  <div
                    className="relative mb-2 md:mb-3 rounded-sm overflow-hidden active:scale-[0.98] transition-transform"
                  ...
                  <p className="text-[10px] md:text-sm text-foreground/50 leading-relaxed line-clamp-2 md:line-clamp-3">
                    {item.description}
                  </p>
                  <div className="mt-2 md:mt-3 pt-2 md:pt-3 border-t border-border/[0.06] flex items-center justify-between">
